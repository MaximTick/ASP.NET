...
namespace Lab06_WebApp.TMAService {
    ...
    public interface TMAWebServiceSoap {
        ...
        Lab06_WebApp.TMAService.GetHistoryResponse GetHistory(Lab06_WebApp.TMAService.GetHistoryRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetHistory", ReplyAction="*")]
        System.Threading.Tasks.Task<Lab06_WebApp.TMAService.GetHistoryResponse> GetHistoryAsync(Lab06_WebApp.TMAService.GetHistoryRequest request);
    }
    ...
    public partial class GetHistoryRequest {
        ...
        public Lab06_WebApp.TMAService.GetHistoryRequestBody Body;
        
        public GetHistoryRequest() {
        }
        
        public GetHistoryRequest(Lab06_WebApp.TMAService.GetHistoryRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class GetHistoryResponse {
        ...
        public Lab06_WebApp.TMAService.GetHistoryResponseBody Body;
        
        public GetHistoryResponse() {
        }
        
        public GetHistoryResponse(Lab06_WebApp.TMAService.GetHistoryResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface TMAWebServiceSoapChannel : Lab06_WebApp.TMAService.TMAWebServiceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TMAWebServiceSoapClient : System.ServiceModel.ClientBase<Lab06_WebApp.TMAService.TMAWebServiceSoap>, Lab06_WebApp.TMAService.TMAWebServiceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Lab06_WebApp.TMAService.GetHistoryResponse Lab06_WebApp.TMAService.TMAWebServiceSoap.GetHistory(Lab06_WebApp.TMAService.GetHistoryRequest request) {
            return base.Channel.GetHistory(request);
        }
        
        public string GetHistory() {
            Lab06_WebApp.TMAService.GetHistoryRequest inValue = new Lab06_WebApp.TMAService.GetHistoryRequest();
            inValue.Body = new Lab06_WebApp.TMAService.GetHistoryRequestBody();
            Lab06_WebApp.TMAService.GetHistoryResponse retVal = ((Lab06_WebApp.TMAService.TMAWebServiceSoap)(this)).GetHistory(inValue);
            return retVal.Body.GetHistoryResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Lab06_WebApp.TMAService.GetHistoryResponse> Lab06_WebApp.TMAService.TMAWebServiceSoap.GetHistoryAsync(Lab06_WebApp.TMAService.GetHistoryRequest request) {
            return base.Channel.GetHistoryAsync(request);
        }
        
        public System.Threading.Tasks.Task<Lab06_WebApp.TMAService.GetHistoryResponse> GetHistoryAsync() {
            Lab06_WebApp.TMAService.GetHistoryRequest inValue = new Lab06_WebApp.TMAService.GetHistoryRequest();
            inValue.Body = new Lab06_WebApp.TMAService.GetHistoryRequestBody();
            return ((Lab06_WebApp.TMAService.TMAWebServiceSoap)(this)).GetHistoryAsync(inValue);
        }
    }
}
